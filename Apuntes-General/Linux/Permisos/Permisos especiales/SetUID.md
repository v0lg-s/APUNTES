...
- El bit de *SetUID* se representa por una *'s'* y se muestra en el bit de permisos de ejecución del grupo de bits de [[1. Tipos de permisos y Usuarios#1. Usuario/User|1. Tipos de permisos y Usuarios]].
...
Se activa el bit mediante el comando [[3. Cambiar Permisos|chmod]]  de la misma manera en que cambiamos los permisos.
