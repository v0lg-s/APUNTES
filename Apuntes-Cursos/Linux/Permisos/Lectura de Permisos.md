...
* -*rwx rwx rwx* : 
	* El primer grupo de tres bits indica los permisos que el dueño "[[Tipos de permisos y Usuarios#1. Usuario/User|User]]" del archivo tiene, 
	* El segundo grupo de bits indica los permisos que el grupo "[[Tipos de permisos y Usuarios#2. Grupo/Group|Group]]" especificado tiene sobre el archivo
	* El último grupo de bits indica los permisos que otros "[[Tipos de permisos y Usuarios#3. Otros/Other|Other]]" usuarios tienen sobre dicho archivo.
