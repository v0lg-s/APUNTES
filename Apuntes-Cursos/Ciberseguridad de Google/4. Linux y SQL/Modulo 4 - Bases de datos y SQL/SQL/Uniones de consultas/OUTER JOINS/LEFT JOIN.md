**LEFT JOIN** retorna todos los registros de la primer tabla, pero solo devuelve registros de la segunda tabla que tienen el mismo valor en una columna especificada.
![[LEFT-JOIN.png]]
**EJEMPLO:** 
