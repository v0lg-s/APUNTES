Son directrices que se usan para crear planes que ayuden a mitigar riesgos y amenazas a la información y privacidad. 

Proporcionan un enfoque robusto para implementar un [[Glosario Introducción#Ciclo de vida de seguridad|ciclo de vida de seguridad]].

Es el Instituto Nacional de Estándares y Tecnología (NIST) quien se encarga de desarrollar marcos de cumplimiento voluntario que las organizaciones pueden usar para gestionar el riesgo.
# Propósito de los marcos de seguridad

En inglés Security Frameworks, tienen distintos propósitos, entre ellos:
- Proteger la información de identificación personal ([[Información sensible#PII (Personally Identifiable Information)|PII]]).
- Asegurar información financiera.
- Identificar las debilidades o vulnerabilidades de seguridad.
- Administrar los riesgos organizacionales.
- Alinear la seguridad con los objetivos comerciales.

# Componentes de los marcos
![[ComponentesFrameworksSeg.png]]

## 1. Identificar y documentar los objetivos de seguridad

*Ejemplo:* Si una organización se quiere apegar a una regulación o ley como la GDPR de la Unión Europea, se le pedirá a un analista de datos que documente e identifique las áreas en las que la organización no cumple con la GDPR.

## 2. Establecer directrices para lograr los objetivos de seguridad

*Ejemplo:* Al implementar estándares para cumplir con la GDPR, es posible que la organización necesite desarrollar nuevas políticas sobre como manejar solicitudes de datos de los usuarios individuales.

## 3. Implementación de procesos de seguridad sólidos

*Ejemplo:* En el caso de GDPR, un analista de seguridad que trabaje para una empresa de redes sociales puede ayudar a diseñar procedimientos para garantizar que la organización cumpla con las solicitudes de datos de usuarios verificadas. Solicitudes como cuando un usuario desea eliminar o actualizar información de su perfil.

## 4. Monitoreo y comunicación de los resultados.
*Ejemplo:* El analista de seguridad puede monitorear la red interna de la organización e informar a un gerente o superior de cumplimiento normativo, sobre un posible problema de seguridad que afecte el cumplimiento de GDPR.
...
- CSF - Marco de Ciberseguridad del NIST
- RMF - Marco de Gestión de riesgos del NIST